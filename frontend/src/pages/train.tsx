  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex gap-2">
        ...
        <select value={region} onChange={(e) => setRegion(e.target.value as Region)} className="rounded border border-slate-300 bg-white px-3 py-2 dark:border-slate-700 dark:bg-slate-800">
